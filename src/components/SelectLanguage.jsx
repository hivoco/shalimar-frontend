...
function SelectLanguage({ setLanguage, language }) {
  ...
  return (
    <div className="min-w-72   flex flex-col gap-[11px]  p-[17.5px] opacity-100  shadow-[0_2px_6px_0px_#00000040]  bg-white absolute top-1/2   md:translate-x-[1%]  -translate-y-1/2  z-50">
